...
├────────────────────┼──────────────────┼──────────────────┼──────────────────┼──────────┼──────────┤
│ mat-8192x8192      │  771.1  (1.426)  │  765.9  (1.435)  │  777.6  (1.414)  │   0.99×  │   1.01×  │
├────────────────────┼──────────────────┼──────────────────┼──────────────────┼──────────┼──────────┤
│ % of peak          │   77.9%          │   77.4%          │   78.6%          │          │  989.5TF │
└────────────────────┴──────────────────┴──────────────────┴──────────────────┴──────────┴──────────┘
```

Column definitions:
- **cuBLAS / CuTe DSL / Generated CUDA**: TFLOPS (effective throughput) and (ms) latency
- **CuTe DSL vs cuBLAS**: Speedup ratio (>1.0 = CuTe DSL is faster)
- **Generated CUDA vs cuBLAS**: Speedup ratio (>1.0 = generated is faster)
- **% of peak**: Best config's TFLOPS / GPU theoretical peak
- Header row 1: GPU model, host name. Row 2: GPU index, CUDA toolkit version
