...
from cuda_exec.tasks import run_profile_task  # noqa: E402


def main() -> int:
    parser = argparse.ArgumentParser(
        description="Hardened profile helper for cuda_exec. Profiles the convention-selected executable artifact with NCU.",
    )
    add_metadata_args(parser)
    parser.add_argument("--target-file", action="append", default=[], help="Target artifact to profile")
